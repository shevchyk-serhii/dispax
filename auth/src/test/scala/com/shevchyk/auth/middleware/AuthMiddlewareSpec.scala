...
object AuthMiddlewareSpec extends ZIOSpecDefault {
  ...
  private def makeToken(role: PersonRole, cid: Option[UUID] = Some(companyId)): ZIO[JwtService, Throwable, String] =
  ...
  private def requestWithBearer(token: String): Request =
