...
object ExpenseRoutesSpec extends ZIOSpecDefault {
  ...
  private def driverToken: ZIO[JwtService, Throwable, String] = TestJWT.generateToken(
  ...
  private def dispatcherToken: ZIO[JwtService, Throwable, String] = TestJWT.generateToken(
  ...
  private def clientToken: ZIO[JwtService, Throwable, String] = TestJWT.generateToken(
    userId = TestData.testUserId,
  ...
  private val validExpenseJson = """{"category":"Fuel","amount":45.50,"description":"Full tank"}"""
