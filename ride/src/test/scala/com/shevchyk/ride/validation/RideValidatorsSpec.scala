...
object RideValidatorsSpec extends ZIOSpecDefault {
  ...
  def validLocation(address: String = "Marienplatz 1, Munich") =
  ...
  def suite_createRideApiRequest = suite("CreateRideApiRequest validator")(
  ...
  def suite_assignDriverRequest = suite("AssignDriverRequest validator")(
  ...
  def suite_rideStatusUpdateRequest = suite("RideStatusUpdateRequest validator")(
  ...
  def suite_updateRideApiRequest = suite("UpdateRideApiRequest validator")(
