...
export function CtaWaitlist() {
  ...
  return (
    <section id="contact" className="scroll-mt-20 bg-surface py-28">
      <Container>
        <Reveal className="relative mx-auto flex max-w-3xl flex-col items-center overflow-hidden rounded-3xl bg-gradient-to-br from-graphite-700 via-graphite-800 to-graphite-900 px-8 py-16 text-center shadow-glow md:px-[72px]">
