...
class ClientCompanyService {
  ...
  Future<List<ClientCompany>> getCompanies() async {
    ...
    if (response.statusCode == 200) {
      ...
      return json
          .map((e) => ClientCompany.fromJson(e as Map<String, dynamic>))
          .toList();
    }
    throw ApiException(
      'Failed to fetch client companies: ${response.statusCode}',
    );
  }
  ...
  Future<ClientCompany?> updateCompany(
    String id,
    CreateClientCompanyRequest req,
  ) async {
