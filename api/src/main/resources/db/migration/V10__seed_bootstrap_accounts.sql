-- Bootstrap seed accounts available in ALL environments (including production).
...
--
-- Insertion order: companies → tariffs → company_settings → demo persons
--   → drivers → client_addresses → schedule_days → company_billing_profile.
