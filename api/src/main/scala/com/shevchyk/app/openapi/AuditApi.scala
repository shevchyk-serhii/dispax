...
object AuditApi:
  ...
  private val findByEntityServer: ZServerEndpoint[AuditEnv, Any] =
    findByEntityEndpoint.serverLogic[AuditEnv] { user =>
  ...
  private val recentServer: ZServerEndpoint[AuditEnv, Any] =
    recentEndpoint.serverLogic[AuditEnv] { user =>
