...
object ScheduleValidatorsSpec extends ZIOSpecDefault {
  ...
  def suite_createScheduleDay =
    suite("CreateScheduleDayApiRequest validator")(
  ...
  def suite_createScheduleBatch =
    suite("CreateScheduleBatchApiRequest validator")(
  ...
  def suite_updateScheduleDay =
    suite("UpdateScheduleDayApiRequest validator")(
